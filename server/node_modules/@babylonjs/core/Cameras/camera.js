...
var Camera = /** @class */ (function (_super) {
    ...
    function Camera(name, position, scene, setActiveOnSceneIfNoneActive) {
         ...
         * In scene unit
         */
        _this._orthoLeft = null;
        /**
         * Define the current limit on the right side for an orthographic camera
         * In scene unit
         */
        _this._orthoRight = null;
        /**
         * Define the current limit on the bottom side for an orthographic camera
         * In scene unit
         */
        _this._orthoBottom = null;
        /**
         * Define the current limit on the top side for an orthographic camera
         * In scene unit
         */
        _this._orthoTop = null;
        /**
         ...
         */
        _this._mode = Camera.PERSPECTIVE_CAMERA;
        /**
    ...
    Object.defineProperty(Camera.prototype, "orthoLeft", {
        get: function () {
            return this._orthoLeft;
        },
        set: function (value) {
            this._orthoLeft = value;
            for (var _i = 0, _a = this._rigCameras; _i < _a.length; _i++) {
                var rigCamera = _a[_i];
    ...
    Object.defineProperty(Camera.prototype, "orthoRight", {
        get: function () {
    ...
    Object.defineProperty(Camera.prototype, "orthoBottom", {
        get: function () {
    ...
    Object.defineProperty(Camera.prototype, "orthoTop", {
        get: function () {
