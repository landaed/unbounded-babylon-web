...
var ShaderMaterial = /** @class */ (function (_super) {
     ...
     * @return the material itself allowing "fluent" like uniform updates
     */
    ShaderMaterial.prototype.setQuaternion = function (name, value) {
        this._checkUniform(name);
     ...
     * @return the material itself allowing "fluent" like uniform updates
     */
    ShaderMaterial.prototype.setQuaternionArray = function (name, value) {
        this._checkUniform(name);
        this._quaternionsArrays[name] = value.reduce(function (arr, quaternion) {
    ...
    ShaderMaterial.prototype.isReady = function (mesh, useInstances, subMesh) {
        ...
        if (this.isFrozen) {
            if (storeEffectOnSubMeshes) {
                ...
                if (effect_1 && effect_1._wasPreviouslyReady && effect_1._wasPreviouslyUsingInstances === useInstances) {
                    return true;
                }
            }
        }
    ...
    ShaderMaterial.prototype.bind = function (world, mesh, effectOverride, subMesh) {
        ...
        if (effect && mustRebind) {
            ...
            // Quaternion
            for (name_2 in this._quaternions) {
                effect.setQuaternion(name_2, this._quaternions[name_2]);
            }
            // Matrix
            ...
            // QuaternionArray
            for (name_2 in this._quaternionsArrays) {
                effect.setArray4(name_2, this._quaternionsArrays[name_2]);
            }
            // Uniform buffers
    ...
    ShaderMaterial.prototype.clone = function (name) {
        ...
        // Quaternion
        for (var key in this._quaternions) {
            result.setQuaternion(key, this._quaternions[key]);
        }
        // QuaternionArray
        for (var key in this._quaternionsArrays) {
